 ...
 * the implications!
 */
#define USB_CFG_DEVICE_VERSION  0x07, 0x00
/* Version number of the device: Minor number first, then major number.
 */
#define USB_CFG_VENDOR_NAME     's', 'e', 'r', 'g', '_', 's', 't', 'e', 't', 's', 'u', 'k', '@', 'u', 'k', 'r', '.', 'n', 'e', 't'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'a', 'v', 'r', 'R', 'F', 's', 'e', 'n', 's', 'o', 'r'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    47 //was 22
